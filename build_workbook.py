...
compile VBA, so `assets/vbaProject.bin` must be replaced with a compiled
project exported from Excel after importing that module.  The layout, tables,
names, validation, print setup, and macro button bindings are created here.
"""
